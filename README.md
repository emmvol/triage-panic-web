...
## Sobre el Juego
Triage Panic es un simulador de supervivencia y gestión distópica desarrollado con Flutter y Flame. 
El juego no recolecta datos del usuario y almacena todo el progreso de forma local.
